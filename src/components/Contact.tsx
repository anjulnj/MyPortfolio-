            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Personal: anjul8477@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">COK-KAT, KU Leuven, Belgium</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">Tuesdays & Thursdays, 6–8 PM</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/5 p-8 md:p-10 rounded-3xl border border-white/10 backdrop-blur-sm">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 
                  text-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-1 
                  focus:ring-emerald-500/50 transition-all appearance-none"
                >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  focus:ring-1 focus:ring-emerald-500/50 transition-all resize-none"
